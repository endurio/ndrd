...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/endurio/ndrd/peer)
...
```bash
$ go get -u github.com/endurio/ndrd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/endurio/ndrd/peer#example-package--NewOutboundPeer)  
