...
const (
	// svcName is the name of ndrd service.
	svcName = "btcdsvc"
...
// logServiceStartOfDay logs information about ndrd when the main server has
...
// long-running btcdMain (which is the real meat of ndrd), handles service
...
// installService attempts to install the ndrd service.  Typically this should
...
// removeService attempts to uninstall the ndrd service.  Typically this should
...
// startService attempts to start the ndrd service.
