...
const (
	...
	PreminedSTB = 1000 * 1e6 // util.SatoshiPerBitcoin
...
var MainNetParams = Params{
	...
	ScriptHashAddrID:        0x3F, // starts with S
	PrivateKeyID:            0x26, // starts with 2H-2J (uncompressed) or 6d-6m (compressed)
	...
	// Authorized PKHs for MVP miners
	AuthorizedPKHs: [][20]byte{
		{0x4E, 0xDA, 0xBF, 0xD1, 0x85, 0x94, 0xEC, 0xCA, 0x70, 0xC7, 0x1C, 0x31, 0xF1, 0xF5, 0x69, 0xA6, 0x9A, 0x3C, 0xFA, 0x17},
		{0x83, 0x7B, 0x82, 0xAB, 0xE6, 0x2D, 0xA8, 0x5C, 0x1E, 0x89, 0x36, 0x02, 0xB3, 0x25, 0x66, 0x7A, 0x67, 0x43, 0x4B, 0x2E},
		{0x72, 0x32, 0x66, 0x4C, 0xBE, 0x6B, 0x25, 0x42, 0x09, 0x11, 0x8D, 0x0E, 0x00, 0x0C, 0x6A, 0xA6, 0x04, 0xE9, 0x68, 0x90},
	},
}
...
var SimNetParams = Params{
	...
	// Address encoding magics
	PubKeyHashAddrID:        0x53, // starts with a
