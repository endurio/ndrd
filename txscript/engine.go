// Copyright (c) 2013-2018 The endurio developers
...
var halfOrder = new(big.Int).Rsh(chainec.S256().N, 1)
...
func (vm *Engine) checkPubKeyEncoding(pubKey []byte) error {
	if vm.hasFlag(ScriptVerifyWitnessPubKeyType) &&
		vm.isWitnessVersionActive(0) && !chainec.IsCompressedPubKey(pubKey) {
