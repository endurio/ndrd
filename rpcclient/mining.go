...
func (c *Client) SubmitBlockAsync(block *util.Block, options *chainjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *util.Block, options *chainjson.SubmitBlockOptions) error {
