...
Bitcoin RPC server that uses a ndrd/bitcoin core compatible Bitcoin JSON-RPC
API.  This client has been tested with ndrd (https://github.com/endurio/ndrd),
...
ndrd or btcwallet by default.  However, configuration options are provided to
...
All notifications provided by ndrd require registration to opt-in.  For example,
