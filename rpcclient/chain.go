...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := chainjson.NewGetBlockCmd(hash, chainjson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := chainjson.NewGetBlockCmd(hash, chainjson.Bool(true), nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := chainjson.NewGetBlockCmd(hash, chainjson.Bool(true), chainjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*chainjson.GetBlockVerboseResult, error) {
...
//
// NOTE: This is a endurio extension ported from
