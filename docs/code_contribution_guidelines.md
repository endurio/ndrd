...
reason, the ndrd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire ndrd
...
One of the major design goals of all core ndrd packages is to aim for complete
...
commits](https://github.com/endurio/ndrd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into ndrd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/endurio/ndrd/graphs/contributors)!
...
[ISC license](https://github.com/endurio/ndrd/blob/master/LICENSE).  This is
the same license as all of the code in the ndrd suite.
