...
var helpDescsEnUS = map[string]string{
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in Coin as the value",
	...
	// FeedPriceCmd help
	"feedprice--synopsis": "Feed the market price of STB/USD to the mining node.",
	"feedprice-price":     "Current market price of STB/USD",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (ndrd extension)",
	...
	"getblocktemplateresulttx-fee":     "Difference in value between transaction inputs and outputs (in Atom)",
	...
	"getblocktemplateresult-coinbasevalue":              "Total amount available for the coinbase in Atom",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in Coin/KB",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in Coin/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in Coin/KB",
	...
	"gettxoutresult-value":         "The transaction amount in Coin",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (ndrd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown ndrd.",
	"stop--result0":  "The string 'ndrd stopping.'",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this ndrd instance) and when such a transaction first appears in a newly-attached block.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getrawmembook":         {(*[]string)(nil), (*chainjson.GetRawMembookVerboseResult)(nil)},
	"getorderbook":          {(*[]string)(nil), (*chainjson.GetOrderBookResult)(nil)},
