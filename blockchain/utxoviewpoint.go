...
func (view *UtxoViewpoint) connectTransactions(block *chainutil.Block, stxos *[]SpentTxOut) (*big.Int, error) {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *chainutil.Block) error {
