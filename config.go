...
const (
	defaultConfigFilename        = "ndrd.conf"
	defaultDataDirname           = "data"
	defaultLogLevel              = "info"
	defaultLogDirname            = "logs"
	defaultLogFilename           = "ndrd.log"
	defaultMaxPeers              = 125
	...
	sampleConfigFilename         = "sample-ndrd.conf"
...
// config defines the configuration options for ndrd.
//
...
type config struct {
	...
	MinRelayTxPrice      types.CoinPriceReq `long:"minrelaytxfee" description:"The minimum transaction fee in Coin/kB to be considered a non-zero fee."`
}
...
//
// The above results in ndrd functioning properly without any config settings
...
func loadConfig() (*config, []string, error) {
	...
	cfg := config{
		...
		MinRelayTxPrice:      mempool.DefaultMinRelayTxPrice.ToCoinPriceReq(),
	}
	...
	cfg.minRelayTxPrice = cfg.MinRelayTxPrice.ToPriceReq()
	if err != nil {
...
// createDefaultConfig copies the file sample-ndrd.conf to the given destination path,
