...
var wsHandlersBeforeInit = map[string]wsCommandHandler{
	...
	"notifyneworders":           handleNotifyNewOrders,
	"notifyreceived":            handleNotifyReceived,
	"notifyspent":               handleNotifySpent,
	"session":                   handleSession,
	"stopnotifyblocks":          handleStopNotifyBlocks,
	"stopnotifynewtransactions": handleStopNotifyNewTransactions,
	"stopnotifyneworders":       handleStopNotifyNewOrders,
...
// isNew is true, the tx is is a new transaction, rather than one
// added to the mempool during a reorg.
func (m *wsNotificationManager) NotifyMembookOdr(odr *chainutil.Odr, isNew bool) {
...
func (m *wsNotificationManager) notifyForNewOdr(clients map[chan struct{}]*wsClient, odr *chainutil.Odr) {
...
// watched address result in the output being watched as well for future
// notifications.
func (m *wsNotificationManager) notifyRelevantOdrAccepted(odr *chainutil.Odr,
	clients map[chan struct{}]*wsClient) {
...
func (m *wsNotificationManager) notifyForOdr(ops map[wire.OutPoint]map[chan struct{}]*wsClient,
	addrs map[string]map[chan struct{}]*wsClient, odr *chainutil.Odr, block *chainutil.Block) {
...
fetchRange:
	...
	// Notify websocket client of the finished rescan.  Due to how ndrd
