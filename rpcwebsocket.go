...
// isNew is true, the tx is is a new transaction, rather than one
// added to the mempool during a reorg.
func (m *wsNotificationManager) NotifyMembookOdr(odr *util.Odr, isNew bool) {
...
func (m *wsNotificationManager) notifyForNewOdr(clients map[chan struct{}]*wsClient, odr *util.Odr) {
...
// watched address result in the output being watched as well for future
// notifications.
func (m *wsNotificationManager) notifyRelevantOdrAccepted(odr *util.Odr,
	clients map[chan struct{}]*wsClient) {
...
func (m *wsNotificationManager) notifyForOdr(ops map[wire.OutPoint]map[chan struct{}]*wsClient,
	addrs map[string]map[chan struct{}]*wsClient, odr *util.Odr, block *util.Block) {
