...
/*
ndrd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means ndrd will work 'out of
...
parsed when ndrd starts up.  By default, the configuration file is located at
~/.ndrd/ndrd.conf on POSIX-style operating systems and %LOCALAPPDATA%\ndrd\ndrd.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in Coin/kB to be
